...
class Router {
            ...
            if (Object.prototype.hasOwnProperty.call(routes, path)) {
                ...
                if (conf.name != "404") {
                    ...
                    components.forEach((component) => {
                        this.components.set(component.name, components);
                    });
                }
            }
        }
    ...
    async authenticate(name, isauth) {
        ...
        // console.log(112, name, isauth, authUser, this.unauthRoute);
            ...
            try {
                ...
                if (authUser) {
                    if (!authUser.includes(isverified.role)) {
                        ...
                        let result = this.goTo(this.unauthRoute(), {
                            replace: true,
                        });
    ...
    goTo(routeName, config = {}, callback) {
        try {
            ...
            if (!hash) {
                ...
                console.log(`${routeName} is not found in routes`);
                console.trace();
